...
[![Hackage Version](https://img.shields.io/hackage/v/ghc-compat)](https://hackage.haskell.org/package/ghc-compat)
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:ghc-compat.svg)](https://repology.org/project/haskell:ghc-compat/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:ghc-compat.svg)](https://repology.org/project/haskell:ghc-compat/versions)

Compatibility layer for the `ghc` library

Easily use the `ghc` library across multiple GHC releases..
...
This package is licensed under [The GNU AGPL 3.0 only](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20ghc-compat).
